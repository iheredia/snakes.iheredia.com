...
(function() {
  var Food, MainSnake, MirrorSnake, areAtSamePlace, atFrameRate, bindEvents, collision, distance, drawingCanvas, equiprobable, gridHeight, gridWidth, hideGameOver, intersect, nextColor, playing, randomPosition, setPlaying, showGameOver, _currentColor, _playing;
  ...
  Food = (function() {
    ...
    Food.prototype.regenerateDependingOn = function(snakePosition) {
      while (distance(this.position, {
          x: gridWidth / 2,
          y: gridHeight / 2
        }) < 10 || distance(this.position, snakePosition) < 10) {
        this.position = randomPosition();
      }
