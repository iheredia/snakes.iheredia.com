...
(function() {
  var DrawingCanvas, Food, Game, MainSnake, MirrorSnake, _currentColor, distance, equiprobable, intersect, nextColor, randomPosition,
  ...
  Game = (function() {
        ...
        results.push((function() {
          ...
          for (k = 0, len1 = allSnakes.length; k < len1; k++) {
            ...
            if (firstSnake !== secondSnake && firstSnake.isEating(secondSnake)) {
              results1.push(secondSnake.status = 'dying');
            } else {
    ...
    Game.prototype.removeDying = function() {
